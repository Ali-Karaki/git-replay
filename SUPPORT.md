...
- **Security issues** → see [SECURITY.md](SECURITY.md) — never report those
  publicly.

The in-app **About** page covers how the product works and its keyboard
shortcuts; `docs/architecture.md` and `docs/decisions/` record the technical
design.
