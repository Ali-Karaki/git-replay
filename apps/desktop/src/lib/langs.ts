...
const BY_EXT: Record<string, string> = {
  ...
  sql: "sql", rb: "ruby", php: "php", swift: "swift", lua: "lua",
  pl: "perl", ex: "elixir", exs: "elixir", hs: "haskell", clj: "clojure",
  dart: "dart", r: "r", scala: "scala", groovy: "groovy", gradle: "groovy",
  makefile: "makefile", mk: "makefile", cmake: "cmake", dockerfile: "dockerfile",
};
